...
use cvkg_core::{
    FrameRenderer, RenderStateSnapshot, Renderer, ColorTheme,
    RenderIntensityMode, Rect, DrawMaterial, TelemetryData, Mesh,
};
use crate::window::{WindowManager, SafeAreaInsets};
