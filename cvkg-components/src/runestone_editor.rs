...
/// A code editor with runic syntax highlighting (inspired by CodeEditorView).
...
impl View for RunestoneEditor {
    ...
    fn render(&self, renderer: &mut dyn Renderer, rect: Rect) {
        ...
        if (t * 2.0).fract() > 0.5 {
            ...
            renderer.draw_line(cursor_x, cursor_y, cursor_x, cursor_y + 16.0, [1.0, 0.5, 0.0, 1.0], 2.0);
        }
    }
}
